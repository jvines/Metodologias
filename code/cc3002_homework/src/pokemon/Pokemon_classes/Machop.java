...
import pokemon.Type_classes.Fighting;

public class Machop extends AbstractPokemon implements IType {

  public Machop(String name, int hp, int move_power) {
    this.name = name;
    this.hp = hp;
